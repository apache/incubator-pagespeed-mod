...
class Property {
 public:
  enum Prop {
    ...
    BORDER_SPACING,
    _WEBKIT_BORDER_HORIZONTAL_SPACING,
    ...
    _WEBKIT_MARGIN_START,
    _WEBKIT_MARQUEE,
    _WEBKIT_MARQUEE_DIRECTION,
    _WEBKIT_MARQUEE_INCREMENT,
    _WEBKIT_MARQUEE_REPETITION,
    _WEBKIT_MARQUEE_SPEED,
    _WEBKIT_MARQUEE_STYLE,
    _WEBKIT_MATCH_NEAREST_MAIL_BLOCKQUOTE_COLOR,
    MAX_HEIGHT,
    MAX_WIDTH,
    MIN_HEIGHT,
    MIN_WIDTH,
    ...
    _WEBKIT_TEXT_DECORATIONS_IN_EFFECT,
