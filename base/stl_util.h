...
template <typename Container,
          typename Value,
          std::enable_if<internal::HasFindWithNpos<Container, Value>::value &&
...
template <typename Container,
          typename Value,
          std::enable_if<internal::HasFindWithEnd<Container, Value>::value &&
                           !internal::HasContains<Container, Value>::value>* =
              nullptr>
bool Contains(const Container& container, const Value& value) {
...
template <
    typename Container,
    typename Value,
    std::enable_if<internal::HasContains<Container, Value>::value>* = nullptr>
bool Contains(const Container& container, const Value& value) {
...
template <typename Container,
          typename ConstIter,
          std::enable_if<!internal::IsRandomAccessIter<ConstIter>>* = nullptr>
