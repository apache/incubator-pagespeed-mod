...
ImageCompressionInfo kValidImages[] = {
    ...
    {"basi6a08", 361, 350, 1},   {"basi6a16", 4180, 4133, 1},
    ...
    {"basn6a08", 184, 176, 1},   {"basn6a16", 3435, 3271, 1},
    {"bgai4a08", 214, 209, 1},   {"bgai4a16", 2855, 1980, 1},
    {"bgan6a08", 184, 176, 1},   {"bgan6a16", 3435, 3271, 1},
    {"bgbn4a08", 140, 121, 1},   {"bggn4a16", 2220, 1185, 1},
    {"bgwn6a08", 202, 176, 1},   {"bgyn6a16", 3453, 3271, 1},
    ...
    {"s05i3p02", 134, 119, 1},   {"s05n3p02", 129, 114, 1},
    {"s06i3p02", 143, 128, 1},   {"s06n3p02", 131, 116, 1},
    {"s07i3p02", 149, 134, 1},   {"s07n3p02", 138, 123, 1},
    {"s08i3p02", 149, 134, 1},   {"s08n3p02", 139, 124, 1},
    {"s09i3p02", 147, 132, 1},   {"s09n3p02", 143, 128, 1},
    {"s32i3p04", 355, 340, 1},   {"s32n3p04", 263, 248, 1},
    {"s33i3p04", 385, 370, 1},   {"s33n3p04", 329, 314, 1},
    {"s34i3p04", 349, 332, 1},   {"s34n3p04", 248, 229, 1},
    {"s35i3p04", 399, 384, 1},   {"s35n3p04", 338, 313, 1},
    {"s36i3p04", 356, 339, 1},   {"s36n3p04", 258, 240, 1},
    {"s37i3p04", 393, 378, 1},   {"s37n3p04", 336, 317, 1},
...
GifImageCompressionInfo kValidGifImages[] = {
    ...
    {"basi3p04", 344, 185, 1002, 136}, {"basi3p08", 1737, 1270, 936, 810},
    {"basn3p01", 138, 96, 793, 56},    {"basn3p02", 186, 115, 1162, 74},
    {"basn3p04", 344, 185, 1002, 136}, {"basn3p08", 1737, 1270, 936, 810}};
...
TEST_F(ImageConverterTest, ConvertTransparentGifToPng) {
  ...
  ASSERT_TRUE(PngOptimizer::OptimizePngBestCompression(
      *png_struct_reader_, in, &out, &message_handler_));
  // Verify that the size matches.
  EXPECT_EQ(static_cast<size_t>(25020), out.size()) << "output size mismatch";
}
