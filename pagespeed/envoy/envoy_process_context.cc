...
EnvoyProcessContext::EnvoyProcessContext() : ProcessContext()
{
  ...
  EnvoyRewriteOptions *root_options_  = (EnvoyRewriteOptions *)driver_factory_->default_options();
  EnvoyRewriteOptions *server_options = root_options_->Clone();
  EnvoyRewriteOptions *options        = new EnvoyRewriteOptions(driver_factory_->thread_system());
