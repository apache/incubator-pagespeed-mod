...
void mod_pagespeed_register_hooks(apr_pool_t* pool) {
  ...
  ap_register_output_filter(
      kModPagespeedFilterName, instaweb_out_filter, nullptr,
  ...
  ap_register_output_filter(
      ...
      instaweb_in_place_fix_headers_filter, nullptr,
      static_cast<ap_filter_type>(AP_FTYPE_CONTENT_SET + 1));
  ...
  ap_hook_log_transaction(pagespeed_log_transaction, nullptr, nullptr, APR_HOOK_LAST);
  ...
  ap_hook_map_to_storage(InstawebHandler::instaweb_map_to_storage, nullptr, nullptr,
                         APR_HOOK_FIRST - 2);
}
...
module AP_MODULE_DECLARE_DATA pagespeed_module = {
  ...
  nullptr,  // directives initialized via static ctor calling InstallCommands().
