...
genrule(
    ...
    cmd = ("python ./$(location src/registry_tables_generator/registry_tables_generator.py) ./$(location src/third_party/effective_tld_names/effective_tld_names.dat) $@ $@_test")
)
