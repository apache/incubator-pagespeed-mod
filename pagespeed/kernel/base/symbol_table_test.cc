...
TEST_F(SymbolTableTest, TestInternSensitive) {
  ...
  EXPECT_EQ(s1, GoogleString(*a1.Rep()));
  EXPECT_EQ(s2, GoogleString(*a2.Rep()));
  EXPECT_EQ(s3, GoogleString(*a3.Rep()));
  EXPECT_EQ(s4, GoogleString(*a4.Rep()));
...
TEST_F(SymbolTableTest, TestInternInsensitive) {
  ...
  EXPECT_EQ(0, StringCaseCompare(s1, GoogleString(*a1.Rep())));
  EXPECT_EQ(0, StringCaseCompare(s2, GoogleString(*a2.Rep())));
  EXPECT_EQ(0, StringCaseCompare(s3, GoogleString(*a3.Rep())));
