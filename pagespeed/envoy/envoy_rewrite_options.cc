...
void EnvoyRewriteOptions::AddProperties() {
  ...
  add_envoy_option(
      "", &EnvoyRewriteOptions::statistics_path_, "nsp", kStatisticsPath,
      kServerScope, "Set the statistics path. Ex: /envoy_pagespeed_statistics",
      false);
  add_envoy_option(
      ...
      false);
  add_envoy_option(
      "", &EnvoyRewriteOptions::console_path_, "ncp", kConsolePath, kServerScope,
      "Set the console path. Ex: /pagespeed_console", false);
  add_envoy_option(
      "", &EnvoyRewriteOptions::messages_path_, "nmp", kMessagesPath,
      kServerScope, "Set the messages path.  Ex: /envoy_pagespeed_message",
      false);
  add_envoy_option(
      "", &EnvoyRewriteOptions::admin_path_, "nap", kAdminPath,
      kServerScope, "Set the admin path.  Ex: /pagespeed_admin", false);
  add_envoy_option(
      "", &EnvoyRewriteOptions::global_admin_path_, "ngap", kGlobalAdminPath,
      kProcessScopeStrict,
